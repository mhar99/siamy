...
Pengaturan Akun
@endsection
@extends('siswa/layouts/tempcrud')
@section('css')
...
<div class="content-wrapper" style="width: 1350px">
               ...
               <div class="card-body box-profile">
                <div class="text-center">
                  <img class="profile-user-img img-fluid img-circle fotoProfil" style="width: 128px; border-radius: 50%"
                       src="{{ Auth::guard('siswa')->user()->foto }}"
                       alt="User profile picture">
                </div>

                <h3 class="profile-username text-center" style="margin-top: 10px">{{ Auth::guard('siswa')->user()->nama }}</h3>

                <p class="text-muted text-center">Kelas {{ Auth::guard('siswa')->user()->kelas->nama_kelas }}</p>
               
                <input type="file" name="siswa_image" id="foto-siswa" style="opacity: 0;height:1px;display:none">
              ...
              <div class="card-body">
                <div class="tab-content" style="border: none">
                  <div class="tab-pane active" id="timeline">
                    ...
                    <form class="form-horizontal" method="POST" action="{{ route('siswaUpdateProfil') }}" id="formProfil">
                      @csrf
                      <div class="form-group row">
                        <label for="inputName" class="col-sm-2 col-form-label">NIS</label>
                        <div class="col-sm-10">
                          <input type="text" class="form-control" id="inputName" placeholder="Name" value="{{ Auth::guard('siswa')->user()->nis }}" name="nis">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          <input type="text" class="form-control" id="inputEmail" placeholder="Email" value="{{ Auth::guard('siswa')->user()->nama }}" name="nama">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          <input type="text" class="form-control" id="inputName2" placeholder="Name" value=" {{ Auth::guard('siswa')->user()->kelas->nama_kelas }}" disabled>
                        </div>
                      </div>
                      <div class="form-group row">
                  ...
                  <div class="tab-pane" id="settings">
                    ...
                    <form class="form-horizontal" method="POST" action="{{ route('siswaChangePassword') }}"  id="changePasswordAdminForm">
                      @csrf
                      <div class="form-group row">
                      ...
                      <div class="form-group row">
                        <div class="offset-sm-3 col-sm-8">
                          <button type="submit" class="btn btn-primary" style="padding: 10px 20px 10px 20px">Simpan</button>
                          <a href="/siswa/home" class="btn btn-secondary" style="padding: 10px 20px 10px 20px">Kembali</a>
                        </div>
                      </div>
                    </form>
                  </div>
  ...
  <script>
     $(".btn-ganti").on("click", function(){
      ...
      $('#foto-siswa').ijaboCropTool({
      preview : '.fotoProfil',
      setRatio:1,
      allowedExtensions: ['jpg', 'jpeg','png'],
      buttonsText:['OK','BATAL'],
      buttonsColor:['#30bf7d','#ee5155', -15],
      processUrl:'{{ route("siswaPictureUpdate") }}',
