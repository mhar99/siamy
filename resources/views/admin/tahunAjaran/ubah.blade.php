...
<div class="col-10 grid-margin" style="margin-left: 100px">
  <div class="card">
    <div class="card-body">
      <h4 class="card-title">Ubah Tahun Pelajaran</h4>
      <form class="form-sample" action="/updatetahun/{{ $tahun->id }}" method="post">
         @csrf
        <div class="row">
          <div class="col-md-6">
            <div class="form-group row">
              ...
              <div class="col-sm-15">
                <input type="text" class="form-control" name="tahun_ajaran" value="{{ $tahun->tahun_ajaran }}" />
